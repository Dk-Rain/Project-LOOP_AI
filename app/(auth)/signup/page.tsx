...
export default function SignupPage() {
  ...
  const canSubmit = fullName && email && workspaceName && isPasswordValid;
  ...
  return (
    <div className="glass rounded-2xl border border-zinc-200 p-8 shadow-xl bg-white relative max-w-md mx-auto my-12">
      {/* Glow highlight */}
      ...
      {errorMsg && (
        <div className="mb-4 p-3 bg-red-50 border border-red-100 text-red-655 text-red-700 text-xs rounded-xl font-medium">
          {errorMsg}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Workspace Name */}
        <div className="space-y-1.5">
          <label htmlFor="workspaceName" className="text-xs font-semibold text-zinc-500">
          ...
          <div className="relative">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-zinc-400">
              ...
              <rect width="4" height="4" x="9" y="9" rx="0.5" ry="0.5" />
            </svg>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full mt-2 inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-600/20 hover:bg-indigo-500 transition disabled:opacity-50 disabled:cursor-not-allowed active:scale-98"
        >
